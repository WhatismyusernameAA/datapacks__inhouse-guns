...
execute if predicate guns:item/scattergun/scattergun_holding unless predicate guns:item/scattergun/scattergun_holding_offhand run item replace entity @s weapon.mainhand with air
execute if predicate guns:item/scattergun/scattergun_holding_offhand run item replace entity @s weapon.offhand with air
