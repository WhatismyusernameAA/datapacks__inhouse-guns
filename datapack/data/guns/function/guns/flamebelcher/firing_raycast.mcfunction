...
# PARTICLES
particle minecraft:flame ~ ~ ~ 0.5 0.5 0.5 0.01 10 force
...
execute if score @s gwp__gun-range matches 0.. positioned ^ ^ ^1 if block ~ ~ ~ #guns:air_like_groups run function guns:guns/flamebelcher/firing_raycast