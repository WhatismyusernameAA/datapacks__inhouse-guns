...
execute if predicate guns:item/guns/flamebelcher/holding unless predicate guns:item/guns/flamebelcher/holding_offhand run item replace entity @s weapon.mainhand with air
execute if predicate guns:item/guns/flamebelcher/holding_offhand run item replace entity @s weapon.offhand with air
