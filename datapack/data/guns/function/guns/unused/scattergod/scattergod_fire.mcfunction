...
tag @s add gwp__shot
execute at @s positioned ^ ^ ^1.4 anchored eyes run function guns:guns/unused/scattergod/scattergod_raycast
...
playsound minecraft:item.trident.thunder player @a ~ ~1 ~ 3 2

playsound minecraft:entity.generic.explode player @a ~ ~ ~ 1 0.1
playsound minecraft:entity.shulker.shoot player @a ~ ~ ~ 1 0.1
playsound minecraft:entity.zombie.attack_iron_door player @a ~ ~ ~ 1 0.1
