...
execute positioned ~-2 ~-2 ~-2 as @e[type=!#guns:gun_undamageable,dx=2, dy=2, dz=2,tag=!gwp__shot,sort=nearest] at @s run function guns:guns/revolver/firing_penetrate-effects
