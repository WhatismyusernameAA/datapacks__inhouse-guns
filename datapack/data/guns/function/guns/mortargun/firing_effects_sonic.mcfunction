...
tag @s add gwp__shot
execute at @s positioned ^ ^ ^1.4 anchored eyes run function guns:guns/scattergun/scattergun_raycast_sonic
tag @s remove gwp__shot

# effects
playsound minecraft:entity.firework_rocket.large_blast player @a ~ ~1 ~ 3 0.5
playsound minecraft:entity.warden.sonic_boom player @a ~ ~ ~ 1 0.5
